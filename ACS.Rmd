...
```{r libs, eval = FALSE, echo = FALSE, results = "hide", warning = FALSE, error = FALSE, message = FALSE}
...
```{r chunk2, eval = TRUE, echo = FALSE, results = "hide", warning = FALSE, error = FALSE, message = FALSE}
